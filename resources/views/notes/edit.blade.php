...
<div class="main-content">
    ...
    <div class="cu-layout">
        ...
        {{-- Form --}}
        <form action="{{ route('notes.update', $note->id) }}" method="POST" id="noteForm">
            @csrf
            @method('PUT')
                ...
                <div class="cu-section">
                    ...
                    <div class="cu-section-body">
                        <div class="cu-field" style="margin-bottom:0;">
                            ...
                            <textarea name="content" id="content" style="display:none;">{{ old('content', $note->content) }}</textarea>
                            ...
                            <div class="cu-field" style="margin-bottom:0;">
                                ...
                                <div class="cu-input-wrap">
                                    ...
                                    <input type="date" name="date" id="date"
                                           ...
                                           value="{{ old('date', $note->date ? \Carbon\Carbon::parse($note->date)->format('Y-m-d') : '') }}">
                                </div>
                            ...
                            <div class="cu-field" style="margin-bottom:0;">
                                ...
                                <div class="cu-input-wrap">
                                    ...
                                    <input type="time" name="time" id="time"
                                           ...
                                           value="{{ old('time', $note->time ? \Carbon\Carbon::parse($note->time)->format('H:i') : '') }}">
                                </div>
